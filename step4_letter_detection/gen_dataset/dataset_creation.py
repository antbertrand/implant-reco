...
def create_chips(dest_folder=".", n=200, side_length=224):
...
with open("ann_train.csv", 'w'):
    pass
with open("ann_test.csv", 'w'):
    pass
create_chips(dest_folder='./split_dataset')
