...
def create_chips(dest_folder=".", n=1000, side_length=800):
    ...
    for k in range(n):
        ...
        if k<n*0.8:
            ...
            file_name = "/storage/eurosilicone/ds_step4/split_dataset_big2/ann_train.csv"

        else:
            path_name = os.path.join(dest_folder, "test", "GENERATED_CHIP-{}.jpg".format(k))
            file_name = "/storage/eurosilicone/ds_step4/split_dataset_big2/ann_test.csv"
...
with open("/storage/eurosilicone/ds_step4/split_dataset_big2/ann_train.csv", 'w'):
    pass
with open("/storage/eurosilicone/ds_step4/split_dataset_big2/ann_test.csv", 'w'):
    pass
create_chips(dest_folder='/storage/eurosilicone/ds_step4/split_dataset_big2/')
