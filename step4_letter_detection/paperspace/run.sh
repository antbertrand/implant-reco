...
mkdir /storage/eurosilicone/ds_step4/gen_dataset
mkdir /storage/eurosilicone/ds_step4/gen_dataset/val
mkdir /storage/eurosilicone/ds_step4/gen_dataset/train
