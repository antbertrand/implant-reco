...
Classification of different types of plastic using deep learning.
...
### DL / Install the client

```
git clone git@github.com:numericube/cloudlabel-client.git
...
#(attendre un peu ; si ça plante car connexion réseau tombée "cannot join current thread", relancer simplement.)
```
